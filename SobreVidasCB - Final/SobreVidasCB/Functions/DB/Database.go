...
func OpenConnection() *sql.DB {
	...
	db.Query("CREATE TABLE IF NOT EXISTS pacientes(Id SERIAL NOT NULL,Nome varchar(150),CPF varchar(20) UNIQUE,Nascimento int NOT NULL,idade int not null,Id_Gen int NOT NULL,Telefone bigint NOT NULL,Email varchar(150) NOT NULL,Mae varchar(150) NOT NULL,uf varchar(20),bairro varchar(50),tabagista int NOT NULL,def int NOT NULL,etilista int NOT NULL,m40 int not null,absenteista int not null,acsresponsavel int,situacao varchar(20),CONSTRAINT pk_pc PRIMARY KEY(id));")
